...
export const Footer: React.FC = () => {
  const instagramShots = [
    { id: 1, img: ASSET_LIBRARY.kitchenIsland, alt: 'Travertine Island Kitchen' },
    { id: 2, img: ASSET_LIBRARY.bedroomJapandi, alt: 'Japandi Master Suite' },
    { id: 3, img: ASSET_LIBRARY.livingAcoustic, alt: 'Acoustic Fluted Living Lounge' },
    { id: 4, img: ASSET_LIBRARY.kitchenLShaped, alt: 'Cashmere Acrylic Cabinetry' },
    { id: 5, img: ASSET_LIBRARY.bedroomClassical, alt: 'Fluted Dressing Walk-In' },
    { id: 6, img: ASSET_LIBRARY.afterFinished, alt: 'Turnkey Handover Living Room' },
  ];

  return (
    <footer className="bg-[#F3EFE6] border-t border-[#EDE7DC] pt-20 pb-12 text-[#181615] relative overflow-hidden">
      {/* Decorative subtle texture watermark */}
      <div className="absolute right-0 bottom-0 text-[180px] font-serif font-light text-[#DDD5C7]/20 select-none pointer-events-none -mb-16 -mr-10 leading-none">
        SHINEX
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 py-16 border-b border-[#DDD5C7]/70">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-2">
              <span className="font-serif text-3xl font-medium tracking-tight text-[#181615]">
          ...
          <div className="space-y-4">
            <h3 className="text-xs uppercase tracking-[0.16em] font-semibold text-[#181615] flex items-center gap-1.5">
